...
- A suitable default policy reference is similar to `{DiscoveryConnectorPolicyProject}:Cloudantdb1`.
- This connector uses `applicationType="online"` and `authenticationMethod="BASIC"`. The policy includes a `<hostname>` field for the Cloudant instance host URL.

## Example policy
```xml
<?xml version="1.0" encoding="UTF-8"?>
<policies>
    <policy longDescription="" policyName="Cloudantdb1" policyTemplate="online_v1_basic" policyType="cloudantdb" shortDescription="" version="">
        <credentialName/>
