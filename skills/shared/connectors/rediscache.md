...
- A suitable default policy reference is similar to `{DiscoveryConnectorPolicyProject}:Rediscache1`.
- Note: the Redis policy uses `policyType="RedisConnection"` and `policyTemplate="RedisConnection"`, which differs from the standard connector pattern.

## Example policy
```xml
<?xml version="1.0" encoding="UTF-8"?>
<policies>
    <policy longDescription="" policyName="Rediscache1" policyTemplate="RedisConnection" policyType="RedisConnection" shortDescription="" version="">
