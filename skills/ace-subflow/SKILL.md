---
name: ace-subflow
description: Use when the user wants to create or modify IBM App Connect Enterprise Toolkit .subflow files using validated node types and ACE Toolkit conventions.
---

# ACE Message Flow Skill

## Purpose
- Use this skill when the user asks to create or modify ACE Toolkit `.subflow` files that do not require connector-specific policy guidance.
- This skill is particularly important if both message flows and subflows are involved and especially if there are relationships between more than one project
...
3. [`skills/shared/subflow-rules.md`](../shared/subflow-rules.md)
4. [`skills/shared/message-flow-rules.md`](../shared/message-flow-rules.md)
5. [`skills/shared/node-types.md`](../shared/node-types.md)
6. [`skills/shared/review-checklist.md`](../shared/review-checklist.md)

## Critical rules
- Create ACE Toolkit `.subflow` files, not ACE Designer YAML.
...
## Output requirements
- Create or update the requested subflow artifacts.
